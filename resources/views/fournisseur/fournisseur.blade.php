    ...
    <div class="p-10 mb-12 m_auto"><!-- Bloc du tableau des transactions -->
        <table>
            <thead>
                ...
                <th class="p-4 m-auto border-2 border-solid w-3/3">ID_Fournisseur</th>
                <th class="w-1/3 m-auto border-2 border-solid">Nom</th>
                <th class="w-1/3 m-auto border-2 border-solid">Description</th>
                </tr>
            </thead>
            <tbody">
