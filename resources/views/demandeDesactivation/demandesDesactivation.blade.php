<x-app-layout>
    ...
    <div class="w-2/4 text-left mt-5">
        <h2 class="text-5xl font-bold text-white mx-9">Demandes de désactivation de compte</h2>
    </div>

    <div class="m-auto w-11/12 text-right">
        <form method="GET" action="{{ route('demandesDeDesactivationFiltre') }}">
            <select class="mr-16 w-56" name="filtre_demandeDesac" id="filtre_demandeDesac">
    ...
    <div>
        <table id="table_demandeDesac" class=" m-auto text-center">
            <thead>
            ...
            <tbody>
                ...
                <tr class="bg-[#FFFFFF]">
                    ...
                    <td class="pt-5 pb-5 border-2 border-solid">
                        <form method="GET" action="{{ route('demandeDeDesactivation') }}">
